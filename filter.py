...
FORBIDDEN_WORDS = [
    ...
    "سعوده", "سعودة", "مسيار", "المسيار", "اتواصل واتساب", "مــ ـرافق",
    ...
    "تقديم طلب", "استفسار عن", "معلومات حول", "بدون إذن", "تقــ ـريـ ـر",
    ...
    "شهادات صحية", "طاقم التدريس", "ذوو خبرة" ,"إجــ  ـازة" , "مــ ـرضــ ـية"
